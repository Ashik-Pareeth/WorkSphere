  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Review and rate your team's performance.</p>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="p-4 text-sm font-semibold text-gray-600">Tasks Evaluated</th>
              ...
              {appraisals.length === 0 ? (
                ...
                appraisals.map((app) => (
                  <tr key={app.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-4 text-sm text-gray-600">
                      {app.tasksCompletedInPeriod} completed ({app.tasksOverdueInPeriod} overdue)
                    </td>
                    ...
                    <td className="p-4">
                      ...
                      {app.status === "PENDING" && (
                        <span className="text-gray-500 text-sm">Awaiting Employee</span>
                      )}
                    </td>
                  </tr>
                ))
      ...
      {selectedAppraisal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-lg mx-4">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Manager Review</h2>
            <p className="text-sm text-gray-500 mb-4">
              Evaluating {selectedAppraisal.employeeName}
            </p>

            <div className="bg-gray-50 p-4 rounded-lg mb-4 text-sm">
              <p className="font-medium text-gray-700 mb-1">Employee Self-Evaluation:</p>
              <p className="text-gray-600 mb-2">Rating: {selectedAppraisal.selfRating} / 5</p>
              <p className="text-gray-600 italic">"{selectedAppraisal.selfComments || 'No comments provided.'}"</p>
            </div>

...
const PublicApplyForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Basic Validation
        if (!formData.fullName.trim() || !formData.email.trim() || (!formData.resumeUrl.trim() && !resumeFile)) {
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col items-center justify-center p-4">
                <div className="max-w-md w-full bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl text-center border border-gray-100 dark:border-gray-800">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-8">
                        Thank you for your interest. We have received your application and our HR team will review it shortly.
                    </p>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                            ...
                            <div className="sm:col-span-2 border-t border-gray-200 dark:border-gray-800 pt-6 mt-2">
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Resume Information</h3>
                                <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Please provide a link to your resume OR upload a file directly.</p>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mb-2 mt-1">Google Drive, Dropbox, or Portfolio.</p>
                                        <div className="mt-1">
                                            <input
                                                type="url"
                                                name="resumeUrl"
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mb-2 mt-1">PDF, DOC, or DOCX formats.</p>
                                        <div className="mt-1">
                                            <input
                                                type="file"
                                                name="resumeFile"
                            ...
                            <div className="sm:col-span-2">
                                <label htmlFor="coverNote" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Cover Note
                                </label>
                                <div className="mt-1">
                                    <textarea
                        ...
                        <div>
                            <Button type="submit" className="w-full flex justify-center py-6 text-base font-semibold bg-blue-600 hover:bg-blue-700" disabled={loading}>

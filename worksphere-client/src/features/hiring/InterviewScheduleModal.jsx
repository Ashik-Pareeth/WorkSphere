...
const InterviewScheduleModal = ({ candidate, onClose, onScheduled }) => {
    ...
    useEffect(() => {
        // Fetch all managers/HR capable of interviewing
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-900 w-full max-w-lg rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Schedule Interview</h2>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    <Users className="inline h-4 w-4 mr-1 text-gray-400" /> Interviewer
                                </label>
                                <select
                                    name="interviewerId"
                                    required
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    <CalendarIcon className="inline h-4 w-4 mr-1 text-gray-400" /> Date & Time
                                </label>
                                <input
                                    type="datetime-local"
                                    name="scheduledAt"

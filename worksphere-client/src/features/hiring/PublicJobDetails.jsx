...
import { Building2, MapPin, Clock, ArrowLeft, Share2, Calendar, LayoutDashboard } from 'lucide-react';
        ...
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-[#0a0f1c] flex flex-col items-center justify-center p-4">
                <div className="text-center max-w-md">
                    <h2 className="text-2xl font-bold font-sora text-slate-900 dark:text-white mb-2">Position Unavailable</h2>
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#0a0f1c] text-slate-900 dark:text-slate-200 font-dm">
            <nav className="border-b bg-white dark:bg-slate-900/50 border-slate-200 dark:border-white/5 sticky top-0 z-50 backdrop-blur-md">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <Link to="/careers" className="flex items-center text-sm font-medium text-slate-500 hover:text-blue-600 transition-colors">
                    ...
                    <div className="hidden sm:flex items-center gap-2">
                        <div className="w-6 h-6 rounded bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-sm">
                            <span className="text-white font-bold font-sora text-[10px]">W</span>
                        </div>
                        <span className="font-bold text-sm tracking-tight font-sora">WorkSphere</span>
                    </div>
                </div>
            </nav>
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <header className="mb-10">
                    ...
                    <div className="flex items-center gap-4 border-y border-slate-200 dark:border-white/5 py-6">
                        ...
                        <Button variant="outline" size="icon" className="h-12 w-12 border-slate-200 dark:border-white/10 dark:hover:bg-white/5" onClick={() => {
                ...
                <article className="prose prose-slate dark:prose-invert prose-blue max-w-none">
                    <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-white/5 rounded-2xl p-6 md:p-10 shadow-sm leading-relaxed whitespace-pre-wrap">
                        {/* If job.description contains markdown, ReactMarkdown will render it nicely */}
                        <ReactMarkdown className="text-[16px] text-slate-700 dark:text-slate-300">
                ...
                <div className="mt-12 mb-20 p-8 md:p-12 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900/80 dark:to-indigo-950/30 rounded-3xl border border-blue-100 dark:border-indigo-500/10 text-center">
                    <h3 className="text-2xl font-bold font-sora text-slate-900 dark:text-white mb-4">Ready to join us?</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-lg mx-auto">
                        Submit your application and our talent team will review your profile.
                    </p>
                    <Button 
                        onClick={() => navigate(`/jobs/${job.id}/apply`)} 
                        size="lg" 

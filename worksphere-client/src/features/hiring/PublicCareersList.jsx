  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        ...
        console.error('Failed to fetch public jobs', err.response || err);
      ...
      <nav className="border-b bg-white dark:bg-slate-900/50 border-slate-200 dark:border-white/5 sticky top-0 z-50 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold text-lg tracking-tight font-sora group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
              WorkSphere
            </span>
          </Link>
          <Link to="/">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            We're building the future of workplace management. Discover your
            next career move and help us shape the modern OS for modern teams.
          </p>
        </div>

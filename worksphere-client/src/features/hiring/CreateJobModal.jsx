    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                jobPosition: { id: formData.jobPositionId },
                openSlots: parseInt(formData.openSlots, 10),
                status: 'OPEN',
                hrOwner: { id: user.id }, // Logged in HR tracking
            ...
            <div className="bg-white dark:bg-gray-900 w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-800 flex flex-col max-h-[90vh]">
                ...
                <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Create Job Opening</h2>
                            <p className="text-sm text-gray-500">Publish a new position to the public portal.</p>
                        </div>
                    </div>
                ...
                <div className="p-6 overflow-y-auto">
                    <form id="createJobForm" onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    <Building2 className="inline h-4 w-4 mr-1 text-gray-400" /> Department <span className="text-red-500">*</span>
                                </label>
                                <select
                                    name="departmentId"
                                    required
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
                                >
                                    <option value="" disabled>Select System Position</option>
                                    {jobPositions.map(p => (
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    <Users className="inline h-4 w-4 mr-1 text-gray-400" /> Open Slots <span className="text-red-500">*</span>
                                </label>
                                <input
                                    type="number"
                                    name="openSlots"
